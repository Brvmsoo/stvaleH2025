...
yes.addEventListener("click", () => {
  ...
  text.innerHTML = "LET4S GOOOOOOOOOO 😘";
  yes.innerHTML = '<a href="https://www.instagram.com/pierrot_brch/">Message me</a>';// inside the " " put your social media profile link
  yes.style.height = "90%";
  yes.style.width = "96%";
  no.style.display = "none";
  setTimeout(() => {
